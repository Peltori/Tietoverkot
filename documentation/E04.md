...
![](/E04/Harjoitus_kuvat/Vyos_importtaus.png)
...
![](/E04/Harjoitus_kuvat/Looginen_topologia.png)<br/>

Alla kuva fyysisestä topologia piisrustuksestani<br/>

![](/E04/Harjoitus_kuvat/Fyysinen_topologia.png)<br/>
...
![](/E04/Harjoitus_kuvat/Switch1_vlan_waitingstations.png)<br/>

![](/E04/Harjoitus_kuvat/Switch2_vlan_waitingstations.png)<br/>
...
![](/E04/Harjoitus_kuvat/Vyos_conf_hupsista.png)<br/>

Tässä sitten korjasin virheeni ja loin eri "tagin" eli "vif" aliverkolle kuten topologia kuvassa on esitetty<br/>

![](/E04/Harjoitus_kuvat/Vyos_conf_hupsista_korjattu.png)<br/>

Tässä konffasin vielä kuvaukset rajapinnoille<br/>

![](/E04/Harjoitus_kuvat/Vyos_conf_kuvaukset.png)<br/>

Tallennetaan välissä<br/>

![](/E04/Harjoitus_kuvat/Vyos_conf_kuvaukset_tallennus.png)<br/>

Lopussa tarkastellaan mitä saatiin aikaan<br/>

![](/E04/Harjoitus_kuvat/Vyos_conf_kuvaukset_tarkastelu.png)<br/>

Tässä vielä lopputarkastelu kaikista konfiguraatioista<br/>

![](/E04/Harjoitus_kuvat/Vyos_conf_lopullinen.png)<br/>

Varmistetaan vielä "show interfaces" komennolla konfiguraation käyttöönotto<br/>

![](/E04/Harjoitus_kuvat/Vyos_lopputulos.png/)<br/>

Tarkastellaan vielä myös reititystaulu "show ip route" komennolla

![](/E04/Harjoitus_kuvat/Vyos_ip_route_komento.png)<br/>

Nimetään myös reititin

![](/E04/Harjoitus_kuvat/Vyos_nimeaminen.png)

# Lubuntujen osoitteistaminen

Manuaalisesti osoitteistetaan molemmat lubuntut seuraavasti<br/>

![](/E04/Harjoitus_kuvat/Lubuntu1_osoitteistaminen.png)<br/>

![](/E04/Harjoitus_kuvat/Lubuntu2_osoitteistaminen.png)<br/>
...
![](/E04/Harjoitus_kuvat/Lubuntu1_osoitteistaminen_ip_addr.png)<br/>

![](/E04/Harjoitus_kuvat/Lubuntu2_osoitteistaminen_ip_addr.png)<br/>


Katsotaan gateway komennolla "route -n" komennolla

![](/E04/Harjoitus_kuvat/Lubuntu1_osoitteistaminen_gateway_route_n.png)<br/>

![](/E04/Harjoitus_kuvat/Lubuntu1_osoitteistaminen_gateway_route_n.png)<br/>

Seuraavaksi kokeillan "ping" komennolla saadaanko yhteys Lubuntu 2 purkista reitittimeen "vyosiin"

![](/E04/Harjoitus_kuvat/Lubuntu2_ping_to_vyos_126.png)
...
![](/E04/Harjoitus_kuvat/Lubuntu2_ping_to_Lubuntu1_ongelma.png)
...
![](/E04/Harjoitus_kuvat/Lubuntu2_ping_to_Lubuntu1_korjattu.png)
...
![](/E04/Harjoitus_kuvat/Switch1_vlan_network_luonti.png)<br/>

Loput vielä komennoista<br/>

![](/E04/Harjoitus_kuvat/Switch1_loput_komennot.png)<br/>

## Vyosin komennot


![](/E04/Harjoitus_kuvat/Vyos_network_devices_luonti.png)<br/>

Katsotaan menikö kuvaukset oikein ja näyttääkö muutenkin oikealta<br/>

![](/E04/Harjoitus_kuvat/Vyos_network_devices_tarkistus.png)<br/>

Tarkistetaan vielä lopuksi menikö konffit perille<br/>

![](/E04/Harjoitus_kuvat/Vyos_tallennus_ja_tarkistus.png)<br/>

## Pingaus eri laitteisiin

Ping Lubuntu1 -> Lubuntu2<br/>

![](/E04/Harjoitus_kuvat/Lubuntu1_to_Lubuntu2_uudet_asetukset_ping.png)<br/>

Ping komento Lubuntu2 -> Lubuntu1<br/>

![](/E04/Harjoitus_kuvat/Lubuntu2_to_Lubuntu1_uudet_asetukset_ping.png)<br/>

Ping komento Lubuntu 1 -> Vyos<br/>

![](/E04/Harjoitus_kuvat/Lubuntu1_to_Vyos_ping.png)<br/>

Ping komento Lubuntu 2 -> Vyos<br/>

![](/E04/Harjoitus_kuvat/Lubuntu2_to_Vyos_ping.png)<br/>

Ping komento Lubuntu 1 -> Switch 1 ja Switch 2><br/>

Tämähän ei toimi aivan kuten haluttiinkin<br/>

![](/E04/Harjoitus_kuvat/Lubuntu1_to_Switch1_Switch2.png)<br/>

Ping komento Lubuntu 2 -> Switch 1 ja Switch 2<br/>

Tämäkään ei toimi aivan kuten haluttiinkin<br/>

![](/E04/Harjoitus_kuvat/Lubuntu2_to_Switch1_Switch2.png)<br/>
...
![](/E04/Harjoitus_kuvat/Lubuntu1_to_Lubuntu2_traceroute.png)<br/>
...
![](/E04/Harjoitus_kuvat/Lubuntu2_to_Lubuntu1_traceroute.png)<br/>
...
![](/E04/Harjoitus_kuvat/Lubuntu1_to_Vyos_traceroute.png)<br/>
...
![](/E04/Harjoitus_kuvat/Lubuntu2_to_Vyos_traceroute.png)<br/>
...
![](/E04/Harjoitus_kuvat/Lubuntu1_to_Switch1_Switch2_traceroute.png)<br/>

Traceroute komento Lubuntu1 -> Switch 1 ja Switch2<br/>

Tässä näemme vain yhden hypyn, koska Lubuntu purkeista ei pääse ollenkaan aliverkkoon missä kytkimet elelevät,<br/>

![](/E04/Harjoitus_kuvat/Lubuntu2_to_Switch1_Switch2_traceroute.png)<br/>
...
![](/E04/Harjoitus_kuvat/Switch1_korjattu_iproute.png)<br/>

Switch2<br/>

Tässä vielä port 3 taggediksi network_devices aliverkolle<br/>
![](/E04/Harjoitus_kuvat/Switch2_network_devices_port3_tagged_korjattu.png)<br/>

Näillä homma lähti pelittämään ja alla kuvat vielä dokumentoituna, että pingaus toimiipi.<br/>

Lubuntu 1<br/>
![](/E04/Harjoitus_kuvat/Lubuntu1_to_switch1_2_korjattu.png)<br/>

Lubuntu2<br/>
![](/E04/Harjoitus_kuvat/Lubuntu2_to_switch1_2_korjattu.png)<br/>
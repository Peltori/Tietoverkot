...
|                 **Selite**                  | **Aliverkon tiedot** |
| :-----------------------------------------: | :------------------: |
| Uusi aliverkon osoite                       | 10.5.51.239          |
| Aliverkon maski                             | /28                  |
| Käytettävien osoitteiden (päätelaite) määrä | 2^4 = 16-2 = 14      |
...
------------------------ #1 Aliverkon Raja -------------------------------
0000 00| 00  -> 0        Verkonosoite (Subnet Address) <br/>
0000 00| 01  -> 1 <br/>
0000 00| 10  -> 2 <br/>
0000 00| 11  -> 3 <br/> Yleislähetysosoite (Broadcast Address) <br/>
...
nnnn nn| hh
------------------------ #2 Aliverkon Raja -------------------------------
0000 01| 00 -> 4        Verkonosoite (Subnet Address) <br/>
0000 01| 01 -> 5 <br/>
0000 01| 10 -> 6 <br/>
0000 01| 11 -> 7 <br/> Yleislähetysosoite (Broadcast Address) <br/>

|                 **Selite**                  | **Aliverkon tiedot** |
| :-----------------------------------------: | :------------------: |
| Uusi aliverkon osoite                       | 10.5.51.4            |
| Aliverkon maski                             | /30                  |
| Käytettävien osoitteiden (päätelaite) määrä | 2^2 = 4-2 = 2        |
...
nnnn nn| hh
------------------------ #3 Aliverkon Raja -------------------------------
0000 10| 00-> 8        Verkonosoite (Subnet Address) <br/>
0000 10| 01-> 9 <br/>
0000 10| 10-> 10 <br/>
0000 10| 11-> 11 <br/> Yleislähetysosoite (Broadcast Address) <br/>

|                 **Selite**                  | **Aliverkon tiedot**  |
| :-----------------------------------------: | :-------------------: |
| Uusi aliverkon osoite                       | 10.5.51.8             |
| Aliverkon maski                             | /30                   |
| Käytettävien osoitteiden (päätelaite) määrä | 2^2 = 4-2 = 2         |
| Ensimmäinen käytettävä (päätelaite) osoite  | 10.5.51.9             |
| Viimeinen käytettävä (päätelaite) osoite    | 10.5.51.10            |
| Yleislähetysosoite                          | 10.5.51.11            |
...
Käytetty pepistä löytyvää opiskelijanumeroa 2205123
                                            vvxyzki
...
esimerkiksi jos n bittien määrä on 6 niin 2^6=64, joten aliverkkojen määrä on 64.
...
10.xy.yz.0/24 = 10.5.51.0/24

10.0.0.0/8    -> osoiteavaruus alkaa?
              -> mihin osoiteavaruus loppuu?
...
10.5.51.0/24 -> tämä aliverkko on osa verkkoa 10.0.0.0/8, koska osoite 10.5.51.0 on osoitteiden -> 10.0.0.0 ja 10.255.255.255 välissä


# Oman julkisen ip osoitteen tutkiminen

Kuva RIPEn sivun haun kautta ip osoittella 81.197.7.80
...
Tämä osoite on RIPE:n jakelema -> rekisteröity JSC "Ukrtelecom" yritykselle
...
Tämä osoite on APNIC:n jakelema -> rekisteröity Aliyn Computing Co.LTD yritykselle
...
Tämä osoite on ARIN:n jakelema -> rekisteröity HP Inc. yritykselle
...
Tämä osoite on ARIN:n jakelema -> rekisteröity T-Mobile USA, Inc:lle
...
![](/E08/Fyysinen_topologia.png)<br/>

Looginen topologia<br/>

![](/E08/Looginen_topologia.png)<br/>

# Kloonataan 3:s vyos

Alla kuva kolmannen vyos koneen network asetuksista virtualboxissa<br/>

![](/E08/Vyos3_network_settings_vm.png)<br/>

Alla kuvat muista vyoseista muutosten jälkeen virtualboxissa<br/>

Vyos1<br/>
![](/E08/Vyos1_network_settings_vm.png)<br/>

Vyos2<br/>
![](/E08/Vyos2_network_settings_vm.png)<br/>
...
![](/E08/Vyos3_osoitteistaminen.png)<br/>

Tarkastellaan menikö komennot perille ennen kuin koomitoidaan muutokset<br/>

![](/E08/Vyos3_osoitteistaminen_tarkistus.png)<br/>

Näyttäisi olevan kunnossa niin ei muuta kuin kommittia ja tallennus<br/>

![](/E08/Vyos3_osoitteistaminen_tallennus.png)<br/>

"show conf" komennon tuloste<br/>

![](/E08/Vyos3_osoitteistaminen_show_conf.png)<br/>

## Vyos 1 ja 2 konfiguraatiot

Osoitteistus ja kuvaus vyos1<br/>
![](/E08/Vyos1_osoitteistaminen.png)<br/>

Osoitteistus ja kuvaus vyos2<br/>
![](/E08/Vyos2_osoitteistaminen.png)<br/>

Tarkastellaan menikö komennot perille vyos1 ja vyos2 koneissa<br/>

Vyos1<br/>
![](/E08/Vyos1_osoitteistaminen_tarkistus.png)<br/>

Vyos2<br/>
![](/E08/Vyos2_osoitteistaminen_tarkistus.png)<br/>

Näyttäisi nämäkin hyviltä, joten kommittia vaan<br/>

Vyos1<br/>
![](/E08/Vyos1_osoitteistaminen_tallennus.png)<br/>

Vyos2<br/>
![](/E08/Vyos2_osoitteistaminen_tallennus.png)<br/>

"show conf" komennon tuloste<br/>

Vyos1<br/>
![](/E08/Vyos1_osoitteistaminen_show_conf.png)<br/>

Vyos2<br/>
![](/E08/Vyos2_osoitteistaminen_show_conf.png)<br/>
...
![](/E08/Vyos1_loopback_osoitteistus.png)<br/>

Vyos2 loopback osoitteistus<br/>
![](/E08/Vyos2_loopback_osoitteistus.png)<br/>

Vyos3 loopback osoitteistus<br/>
![](/E08/Vyos3_loopback_osoitteistus.png)<br/>


Tarkistetaan vielä ennenkuin kommitoidaan<br/>

Vyos1 commit ja save<br/>
![](/E08/Vyos1_loopback_osoitteistus_commit_tallennus.png)<br/>

Vyos2 commit ja save<br/>
![](/E08/Vyos2_loopback_osoitteistus_commit_tallennus.png)<br/>

Vyos3 commit ja save<br/>
![](/E08/Vyos3_loopback_osoitteistus_commit_tallennus.png)<br/>
...
![](/E08/Vyos1_static_route_delete.png)<br/>

Vyos2<br/>
![](/E08/Vyos2_static_route_delete.png)<br/>
![](/E08/Vyos2_static_route_delete_1.png)<br/>

Vyos3<br/>

![](/E08/Vyos3_static_route_delete.png)<br/>

Sitten tarkastelua ja committia sekä muutosten tallennus<br/>

Vyos1<br/>
![](/E08/Vyos1_static_route_delete_commit.png)<br/>

Vyos2<br/>
![](/E08/Vyos2_static_route_delete_commit.png)<br/>

Vyos3<br/>
![](/E08/Vyos3_static_route_delete_commit.png)<br/>
![](/E08/Vyos3_static_route_delete_commit_1.png)<br/>
...
Vyos1<br/>
![](/E08/Vyos1_OSPF_protokolla.png)<br/>

Vyos2<br/>
![](/E08/Vyos2_OSPF_protokolla.png)<br/>

Vyos3<br/>
![](/E08/Vyos3_OSPF_protokolla.png)<br/>

Tarkistetaan vielä miltä näyttää ennen kommittia<br/>

Vyos1<br/>
![](/E08/Vyos1_OSPF_protokolla_tarkistus.png)<br/>

Vyos2<br/>
![](/E08/Vyos2_OSPF_protokolla_tarkistus.png)<br/>

Vyos3<br/>
![](/E08/Vyos3_OSPF_protokolla_tarkistus.png)<br/>

Lopuksi vielä kommitti ja tallennus<br/>

Vyos1<br/>
![](/E08/Vyos1_OSPF_protokolla_tarkistus_commit_save.png)<br/>

Vyos2<br/>
![](/E08/Vyos2_OSPF_protokolla_tarkistus_commit_save.png)<br/>

Vyos3<br/>
![](/E08/Vyos3_OSPF_protokolla_tarkistus_commit_save.png)<br/>
...
Vyos1<br/>
![](/E08/Vyos1_show_neighbor.png)<br/>

Vyos2<br/>
![](/E08/Vyos2_show_neighbor.png)<br/>

Vyos3<br/>
![](/E08/Vyos3_show_neighbor.png)<br/>
...
Vyos1<br/>
![](/E08/Vyos1_show_ip_route_ospf.png)<br/>

![](/E08/Vyos1_show_ip_route.png)<br/>

Vyos2<br/>
![](/E08/Vyos2_show_ip_route_ospf.png)<br/>

![](/E08/Vyos2_show_ip_route.png)<br/>

Vyos3<br/>
![](/E08/Vyos3_show_ip_route_ospf.png)<br/>

![](/E08/Vyos3_show_ip_route.png)<br/>

"show ip ospf database" komennon tuloste<br/>

Vyos1<br/>
![](/E08/Vyos1_show_ip_ospf_database.png)<br/>

Vyos2<br/>
![](/E08/Vyos2_show_ip_ospf_database.png)<br/>

Vyos3<br/>
![](/E08/Vyos3_show_ip_ospf_database.png)<br/>

# Yhteydellisyyden testaaminen

pingaus Lubuntu1 päätelaitteelta -> Lubuntu2 ja Lubuntu3<br/>

![](/E08/ping_Lubuntu1_to_Lubuntu2_and_Lubuntu3.png)<br/>

pingaus Lubuntu2 päätelaitteelta -> Lubuntu1 ja Lubuntu3<br/>

![](/E08/ping_Lubuntu2_to_Lubuntu1_and_Lubuntu3.png)<br/>

pingaus Lubuntu3 päätelaitteelta -> Lubuntu1 ja Lubuntu2<br/>

![](/E08/ping_Lubuntu3_to_Lubuntu1_and_Lubuntu2.png)<br/>

Näyttäisi pingit kulkevan mainiosti<br/>

## traceroute Lubuntu2 päätelaitteelta -> Lubuntu1 ja Lubuntu3<br/>

![](/E08/traceroute_Lubuntu1_to_Lubuntu2_and_Lubuntu3.png)<br/>
...
![](/E08/traceroute_Lubuntu2_to_Lubuntu1_and_Lubuntu3.png)<br/>
...
![](/E08/traceroute_Lubuntu3_to_Lubuntu1_and_Lubuntu2.png)<br/>
